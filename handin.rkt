...
#reader(lib "htdp-intermediate-reader.ss" "lang")((modname handin) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #t)))
(require spd/tags)
...
(check-expect (multiply-odds (cons 4 (cons 4 (cons 4 (cons 4 empty))))) 1)
