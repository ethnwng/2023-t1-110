...
#reader(lib "htdp-beginner-abbr-reader.ss" "lang")((modname m07-regions-refactoring-starter) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #t)))
(require 2htdp/image)
(require spd/tags)
...
;; We call the 'main' part of the two functions
;; The one that is guaranteed to be called
;; -------------
;; Pretty much just make a new function, put both functions in a local defn
;; then call the 'main' part of the two functions in the body.
;; After update the template origin (... x ... y encapsulated)
