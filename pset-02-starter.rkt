...
;; switch to > to >=. If arguments were not in parentheses
...
;; produce true if the input shows a dislike or like
...
(define (fn-for-altitude a)
  (cond [(and (string? a) (string=? a "pre-launch")) (...)]
        [(number? a) (... a)]
        [(and (string? a) (string=? a "post-flight")) (...)]))
...
;; purpose is to determine if the rocket is in flight or not
...
(define (inflight? a)
  (cond [(and (string? a) (string=? a "pre-launch")) false]
        ...
        [(and (string? a) (string=? a "post-flight")) false]))