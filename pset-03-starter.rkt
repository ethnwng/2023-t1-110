...
(check-expect (render-ball (make-ball LEF TOP 0 0))
              (place-image BALL LEF TOP MTS))
(check-expect (render-ball (make-ball LEF (/ TOP 2) 2 0))
              (place-image BALL LEF (/ TOP 2) MTS))
...
(check-expect (bounce-bottom (make-ball (+ LEF 3) (- BOT 6) 2 7))
              (make-ball (+ LEF 3) (- BOT 1) 2 -7))
...
(check-expect (bounce-left (make-ball (+ LEF 4) (+ TOP 20) -6 2))
              (make-ball (+ LEF 1) (+ TOP 20) 6 2))
(check-expect (bounce-left (make-ball (+ LEF 6) (+ TOP 20) -6 2))
              (make-ball (+ LEF 1) (+ TOP 20) 6 2))
...
(check-expect (bounce-right (make-ball (- RIG 4) TOP 5 2))
              (make-ball (- RIG 1) TOP -5 2))
(check-expect (bounce-right (make-ball (- RIG 7) TOP 8 2))
              (make-ball (- RIG 1) TOP -8 2))
...
(check-expect (glide (make-ball (/ WIDTH 2) (/ HEIGHT 2) 5 0))
              (make-ball (+ (/ WIDTH 2 ) 5) (+ (/ HEIGHT 2) 0) 5 0))
(check-expect (glide (make-ball (/ WIDTH 2) (/ HEIGHT 2) 0 5))
              (make-ball (+ (/ WIDTH 2 ) 0) (+ (/ HEIGHT 2) 5) 0 5))
(check-expect (glide (make-ball (/ WIDTH 2) (/ HEIGHT 2) -5 0))
              (make-ball (+ (/ WIDTH 2 ) -5) (+ (/ HEIGHT 2) 0) -5 0))
(check-expect (glide (make-ball (/ WIDTH 2) (/ HEIGHT 2) 0 -5))
              (make-ball (+ (/ WIDTH 2 ) 0) (+ (/ HEIGHT 2) -5) 0 -5))
