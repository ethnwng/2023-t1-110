...
#reader(lib "htdp-intermediate-reader.ss" "lang")((modname m08-abstract-fold-usages-starter) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #t)))
...
; (define (all-course-numbers c) empty)

(define (all-course-numbers c)
  (local [(define (c1 num cred rmr) (cons num rmr))]
...
(define (total-credits c)
  (local [(define (c1 num cred rmr) (+ cred rmr))]
    (fold-course c1 + 0 c)))
